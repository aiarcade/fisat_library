...
void GLMap::setXRotation(int angle)
{
...
void GLMap::setYRotation(int angle)
{
    qNormalizeAngle(angle);
    if (angle != yRot) {
        yRot = angle;
...
void GLMap::setZRotation(int angle)
{
    qNormalizeAngle(angle);
    if (angle != zRot) {
        zRot = angle;
...
void GLMap::resizeGL(int width, int height)
{
